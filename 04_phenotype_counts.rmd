...
walk2(data, c("info", "noinfo"), function(x,y){
  ...
  cairo_pdf(file = glue('figs/fig_v2_{y}_phenotype_count.pdf'), width = 10, height = 10,
            onefile = TRUE)
  {
    print(a_fig)
  }
...
## Plot fitness landscape over time

```{r fitness_landscape, eval=FALSE}
